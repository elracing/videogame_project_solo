...
public class Game extends GameBase{
	...
	//set up reward list
	Reward[] levelUpChoices = new Reward[7];
	...
	String[] map =
		{	    "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA",
				...
				"AAAAAAAAAAAAAAAAAAAAAAAAAAAAAWAAAACAAAAAAAAAAAAAAAAACAAAAAAAAAAACAAAAWAAAAAAAAAAAAAAAAAAAA",
				"AAAAAAAAAAAAAAAAAAAAAAAAAAAAAWAAAAAAAABAAAAAABAAAAAAAAAAAAABAAAAAAAAAWAAAAAAAAAAAAAAAAAAAA",
				"AAAAAAAAAAAAAAAAAAAAAAAAAAAAAWAAAABAAAAAAAAAAAAAAAAAAAAABAAAAAAAAAAAAWAAAAAAAAAAAAAAAAAAAA",
				"AAAAAAAAAAAAAAAAAAAAAAAAAAAAAWAAAAAAAAAAAAABAABAAAAAAAAAAAAABAAAAAAAAWAAAAAAAAAAAAAAAAAAAA",
				"AAAAAAAAAAAAAAAAAAAAAAAAAAAAAWAAAAAAABAAAAAAAAAAAAAAAAAABAAAABAAAAAAAWAAAAAAAAAAAAAAAAAAAA",
				"AAAAAAAAAAAAAAAAAAAAAAAAAAAAAWAABACAAAAAAAAAAAAABAAAAAAAAAAAAAAAACAAAWAAAAAAAAAAAAAAAAAAAA",
				"AAAAAAAAAAAAAAAAAAAAAAAAAAAAAWAAAAAAABAAAAAAAAAAAAAAAAAABAAAAAAAAAAAAWAAAAAAAAAAAAAAAAAAAA",
				"AAAAAAAAAAAAAAAAAAAAAAAAAAAAAWAAAAAAAAAAABAAAABAAAAAAAAAAAAAAAAAAAAAAWAAAAAAAAAAAAAAAAAAAA",
				"AAAAAAAAAAAAAAAAAAAAAAAAAAAAAWAAABAAAAAAAAAAAAAABAAAAAABAAAAAAAAABAAAWAAAAAAAAAAAAAAAAAAAA",
				"AAAAAAAAAAAAAAAAAAAAAAAAAAAAAWAAAACAAAAABAAAAAAAAAAAABAAAAAAABAAACAAAWAAAAAAAAAAAAAAAAAAAA",
				"AAAAAAAAAAAAAAAAAAAAAAAAAAAAAWAAABAAAAAAABAAAAAAAAAAAAAAAAAAAAAAAAAAAWAAAAAAAAAAAAAAAAAAAA",
				"AAAAAAAAAAAAAAAAAAAAAAAAAAAAAWAAAAAAAAAAAAAAAAAABAAAAAAAABAAAAAAAAAAAWAAAAAAAAAAAAAAAAAAAA",
				"AAAAAAAAAAAAAAAAAAAAAAAAAAAAAWAAAAABAAAAAABAAAAAAAAAAAAAAAAABAABAAAAAWAAAAAAAAAAAAAAAAAAAA",
				"AAAAAAAAAAAAAAAAAAAAAAAAAAAAAWAAAACAABAAAAAAACAAAAABAAAAAAAAABAAACAAAWAAAAAAAAAAAAAAAAAAAA",
				"AAAAAAAAAAAAAAAAAAAAAAAAAAAAAWAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAWAAAAAAAAAAAAAAAAAAAA",
				"AAAAAAAAAAAAAAAAAAAAAAAAAAAAAWAAAAABAAAAAAABAAAAAAABAAAAAABAAABAAAAAAWAAAAAAAAAAAAAAAAAAAA",
				"AAAAAAAAAAAAAAAAAAAAAAAAAAAAAWAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAWAAAAAAAAAAAAAAAAAAAA",
				"AAAAAAAAAAAAAAAAAAAAAAAAAAAAAWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWAAAAAAAAAAAAAAAAAAAA",
				"AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA",
				"AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA",
	...
	public void paint (Graphics pen) {
		...
		for (int i = 0; i <map.length; i++) {
			for (int j = 0; j < map[i].length(); j++) {
				...
				if (c == 'B') pen.drawImage(tile[2], j * size - camX, i * size - camY, size, size, null);
				if (c == 'C') pen.drawImage(tile[3], j * size - camX, i * size - camY, size, size, null);
		...
		if (player!= null) {  //no drawing if player is dead
			...
			//bar background
			pen.setColor(Color.DARK_GRAY);
			pen.fillRect((screenWidth / 2) - (expBarWidth / 2), 100, expBarWidth, expBarHeight);
			
			//red bar set up
			
	        pen.setColor(Color.BLUE);
	        int expCurrentBarWidth = (int)((exp / (double) scaledLevelUpExpNeeded) * expBarWidth);
	        pen.fillRect(screenWidth / 2 - (expBarWidth / 2), 100, expCurrentBarWidth, expBarHeight);
			...
			pen.drawString("Round " + roundNumber, screenWidth - 180, 40);
